...
function App() {
  ...
  var data = [{ machID: 'mach-1', pieces: 0, time: 0 }, { machID: 'mach-2', pieces: 0, time: 0 }, { machID: 'mach-3', pieces: 0, time: 0 },{ machID: 'mach-4', pieces: 0, time: 0 },{ machID: 'mach-5', pieces: 0, time: 0 },{ machID: 'mach-6', pieces: 0, time: 0 }];
  var Defaultdata = [{ machID: 'mach-1', pieces: 0, time: 0 }, { machID: 'mach-2', pieces: 0, time: 0 }, { machID: 'mach-3', pieces: 0, time: 0 }, { machID: 'mach-4', pieces: 0, time: 0 }, { machID: 'mach-5', pieces: 0, time: 0 }, { machID: 'mach-6', pieces: 0, time: 0 }];
    ...
    <div id="button">
     ...
     <ReactHTMLTableToExcel
      ...
      variant='light'>
        ...
        Made with love at <img className="img" src={logo}></img>
        </div>
    </>
  );
}
